      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-8">
                <div class="input-group">
                  ...
                  <input id="tanggal_daftar" name="tanggal_daftar" value="<?=$registedit->tanggal_daftar?>" type="text" class="form-control" required="required">
                </div>
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-8">
                <div class="input-group">
                  ...
                  <input id="users_id" name="users_id" value="<?=$registedit->users_id?>" type="text" class="form-control" required="required">
                </div>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-8">
                <textarea id="alasan" name="alasan" cols="40" rows="5" class="form-control" required="required"><?=$registedit->alasan?></textarea>
              </div>
            </div> 
            <div class="form-group row">
              ...
              <div class="col-8">
                <div class="input-group">
                  ...
                  <input id="nosertifikat" name="nosertifikat" value="<?=$registedit->nosertifikat?>" type="text" class="form-control">
                </div>
              </div>
            </div> 
            <div class="form-group row">
